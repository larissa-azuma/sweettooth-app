  ...
  return (
    <div className=" min-h-screen  justify-center items-center px-10 ">
      ...
      <div className="md:grid grid-cols-4 gap-4  justify-center">
        ...
        <PastriesCard img={img2} title="Berry Cake" price="GHC450" />
        <PastriesCard img={img3} title="Icy Cake" price="GHC455" />
        <PastriesCard img={img4} title="Strawcream cake" price="GHC455" />
        <PastriesCard img={img5} title="Shadow Cake" price="GHC405" />
        <PastriesCard img={pic9} title="Snowy" price="GHC405" />
        <PastriesCard img={pic11} title="Cheesy" price="GHC 450" />
        <PastriesCard img={img6} title="Choco icecream" price="GHC408" />
      </div>

            ...
            >
              <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M10 0C4.477 0 0 4.477 0 10c0 5.523 4.477 10 10 10 5.523 0 10-4.477 10-10C20 4.477 15.523 0 10 0zm0 18c-4.418 0-8-3.582-8-8s3.582-8 8-8 8 3.582 8 8-3.582 8-8 8z"
                  />
                  <path
                    fillRule="evenodd"
                    d="M10 4a1 1 0 00-.883 1.478l1.282 2.565H6a1 1 0 100 2h4.399l-1.282 2.566a1 1 0 101.766.966l3-5a1 1 0 000-1.032l-3-5A1 1 0 0010 4z"
                  />
                </svg>
              </span>
              Log in
